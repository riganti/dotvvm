...
namespace DotVVM.Samples.Tests
{
    ...
    public class BasicSamplesRootDomainTests : BasicSamplesTests
    {
        ...
        [TestMethod]
        public void Sample21Test_FullDomain() { Sample21Test(); }
        ...
        [TestMethod]
        public void Sample27Test_FullDomain() { Sample27Test(); }

        [TestMethod]
        public void Sample28Test_FullDomain() { Sample28Test(); }

        [TestMethod]
        public void Sample29Test_FullDomain() { Sample29Test(); }

        [TestMethod]
        public void Sample30Test_FullDomain() { Sample30Test(); }

        [TestMethod]
        public void Sample31Test_FullDomain() { Sample31Test(); }
        ...
        [TestMethod]
        public void Sample34Test_FullDomain() { Sample34Test(); }

        [TestMethod]
        public void Sample35Test_FullDomain() { Sample35Test(); }
