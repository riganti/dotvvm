...
namespace Dotvvm.Samples.Tests{
    public class SamplesRouteUrls{
            ...
            public static string ComplexSamples_SPA_default => "ComplexSamples/SPA/default";

            public static string ComplexSamples_SPA_test => "ComplexSamples/SPA/test";
            ...
            public static string ControlSamples_CheckBox_CheckedItemsNull => "ControlSamples/CheckBox/CheckedItemsNull";

            public static string ControlSamples_CheckBox_InRepeater => "ControlSamples/CheckBox/InRepeater";
            ...
            public static string ControlSamples_TextBox_SelectAllOnFocus => "ControlSamples/TextBox/SelectAllOnFocus";

            public static string ControlSamples_TextBox_SimpleDateBox => "ControlSamples/TextBox/SimpleDateBox";
