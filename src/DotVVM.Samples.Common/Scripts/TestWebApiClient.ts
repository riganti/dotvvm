namespace TestWebApiClient {
    ...
    export class CompaniesClient extends ClientBase {
         ...
         * @return OK
         */
        getWithSorting(sortingOptions_sortDescending?: boolean, sortingOptions_sortExpression?: string): Promise<GridViewDataSetOfCompany> {
        ...
        protected processGetWithSorting(response: Response): Promise<GridViewDataSetOfCompany> {
            ...
            if (status === 200) {
                return response.text().then((_responseText) => {
                let result200: GridViewDataSetOfCompany = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
         ...
         * @return OK
         */
        getWithPaging(pagingOptions_pageIndex?: number, pagingOptions_pageSize?: number, pagingOptions_totalItemsCount?: number): Promise<GridViewDataSetOfCompany> {
         ...
         * @return OK
         */
        getWithSortingAndPaging(sortingOptions_sortDescending?: boolean, sortingOptions_sortExpression?: string, pagingOptions_pageIndex?: number, pagingOptions_pageSize?: number, pagingOptions_totalItemsCount?: number): Promise<GridViewDataSetOfCompany> {
                ...
                if (data["EditRowId"]) {
                    ...
                    for (let key in data["EditRowId"]) {
                        if (data["EditRowId"].hasOwnProperty(key))
                            this.editRowId[key] = data["EditRowId"][key] !== undefined ? data["EditRowId"][key] : <any>null;
                    }
                }
            }
        }
                ...
                if (data["NearPageIndexesProvider"]) {
                    ...
                    for (let key in data["NearPageIndexesProvider"]) {
                        if (data["NearPageIndexesProvider"].hasOwnProperty(key))
                            this.nearPageIndexesProvider[key] = data["NearPageIndexesProvider"][key] !== undefined ? data["NearPageIndexesProvider"][key] : <any>null;
                    }
                }
                this.isFirstPage = data["IsFirstPage"] !== undefined ? data["IsFirstPage"] : <any>null;
                this.isLastPage = data["IsLastPage"] !== undefined ? data["IsLastPage"] : <any>null;
