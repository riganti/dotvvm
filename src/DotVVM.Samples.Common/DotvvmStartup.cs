...
namespace DotVVM.Samples.BasicSamples
{
    public class DotvvmStartup : IDotvvmStartup, IDotvvmServiceConfigurator
    {
        ...
        private static void AddRoutes(DotvvmConfiguration config)
        {
            ...
            config.RouteTable.Add("FeatureSamples_Localization_Globalize", "FeatureSamples_Localization_Globalize", "Views/FeatureSamples/Localization/Globalize.dothtml", presenterFactory: LocalizablePresenter.BasedOnQuery("lang"));
