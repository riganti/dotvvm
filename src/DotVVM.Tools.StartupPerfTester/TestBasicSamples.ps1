...
# Run OWIN tests
./bin/Debug/netcoreapp3.0/DotVVM.Tools.StartupPerfTester.exe ../DotVVM.Samples.BasicSamples.Owin/DotVVM.Samples.BasicSamples.Owin.csproj -t owin -v -r 5

# Run ASP.NET Core tests
./bin/Debug/netcoreapp3.0/DotVVM.Tools.StartupPerfTester.exe ../DotVVM.Samples.BasicSamples.AspNetCoreLatest/DotVVM.Samples.BasicSamples.AspNetCoreLatest.csproj -t aspnetcore -v -r 5