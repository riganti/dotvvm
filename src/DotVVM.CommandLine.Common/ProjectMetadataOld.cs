...
{
    public class ProjectMetadataOld
    {
        public ProjectMetadataOld(
            FileInfo path,
            string projectName,
        ...
        public ProjectMetadataOld WithApiClients(ImmutableArray<ApiClientDefinition> apiClients)
        {
            return new ProjectMetadataOld(
                Path,
                ProjectName,
                ProjectDirectory,
                RootNamespace,
        ...
        public ProjectMetadataOld WithUITestProject(string uiTestProjectPath, string uiTestProjectRootNamespace)
        {
            return new ProjectMetadataOld(
                Path,
                ProjectName,
        ...
        public static ProjectMetadataOld FromJson(ProjectMetadataJsonOld json)
        {
