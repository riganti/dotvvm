...
namespace DotVVM.Framework.Tests.Binding
{
    ...
    public class JavascriptCompilationTests
    {
        ...
        public void JavascriptCompilation_Api_DateParameter()
        {
            ...
            Assert.IsTrue(result.StartsWith("dotvvm.api.invoke(dotvvm.api._testApi,\"postDateToString\",function(){return [dotvvm.serialization.parseDate(DateFrom())];},function(args){return [];},function(args){return [\"DotVVM.Framework.Tests.Binding.TestApiClient/\"];},$element,function(args){return \""));
