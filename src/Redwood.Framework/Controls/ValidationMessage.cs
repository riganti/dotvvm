...
namespace Redwood.Framework.Controls
{
    ...
    public class ValidationMessage : HtmlGenericControl 
    {
        ...
        public static readonly RedwoodProperty AsteriskTextProperty =
            RedwoodProperty.Register<string, ValidationMessage>(c => c.AsteriskText, "*");
        ...
        public static readonly RedwoodProperty ModeProperty =
            RedwoodProperty.Register<ValidationMessageMode, ValidationMessage>(c => c.Mode, ValidationMessageMode.HideWhenValid);
        ...
        public static readonly RedwoodProperty ValidatedValueProperty =
            RedwoodProperty.Register<object, ValidationMessage>(c => c.ValidatedValue, null);
        ...
        public static readonly RedwoodProperty InvalidCssClassProperty =
            RedwoodProperty.Register<string, ValidationMessage>(c => c.InvalidCssClass, "field-validation-error");
        ...
        protected override void AddAttributesToRender(IHtmlWriter writer, RenderContext context)
        {
            ...
            if (validatedValueBinding != null)
            {
                ...
                var options = string.Format("{{'mode':'{0}', 'cssClass':{1}}}", KnockoutHelper.ConvertToCamelCase(Mode), KnockoutHelper.MakeStringLiteral(InvalidCssClass));
