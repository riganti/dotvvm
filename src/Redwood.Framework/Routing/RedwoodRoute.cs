...
namespace Redwood.Framework.Routing
{
    public class RedwoodRoute : RouteBase
    {
        ...
        private Func<IRedwoodPresenter> presenterFactory; 


        /// <summary>
        /// Initializes a new instance of the <see cref="RedwoodRoute"/> class.
        /// </summary>
        public RedwoodRoute(string url, string virtualPath, object defaultValues, Func<IRedwoodPresenter> presenterFactory)
        ...
        /// Initializes a new instance of the <see cref="RedwoodRoute"/> class.
        /// </summary>
        public RedwoodRoute(string url, string virtualPath, IDictionary<string, object> defaultValues, Func<RedwoodPresenter> presenterFactory)
            : base(url, virtualPath, defaultValues)
        {
            this.presenterFactory = presenterFactory;
