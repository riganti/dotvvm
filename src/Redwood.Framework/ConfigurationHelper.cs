...
namespace Redwood.Framework
{
    public static class ConfigurationHelper
    {
        public static void RegisterCommonResources(this RwResourceRepository repo, 
            ...
            string jqueryCdn = "https://code.jquery.com/jquery-migrate-1.2.1.min.js",
            ...
            )
        {
            ...
            repo.Register("bootstrap", new ScriptResource(bootstrapJsLocal, new string[] { "bootstrap-css", "jquery" }));
