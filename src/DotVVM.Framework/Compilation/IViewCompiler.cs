...
namespace DotVVM.Framework.Compilation
{
    ...
    public interface IViewCompiler
    {
        ...
        /// </summary>
        IControlBuilder CompileView(string sourceCode, string fileName, string assemblyName, string namespaceName, string className);

        /// <summary>
        /// Compiles the view to a syntax tree and adds it to the compilation
        /// </summary>
        CSharpCompilation CompileView(string sourceCode, string fileName, CSharpCompilation compilation, string namespaceName, string className);
