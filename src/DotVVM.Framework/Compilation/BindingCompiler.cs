    ...
    public class BindingCompiler : IBindingCompiler
    {
        ...
        public virtual IBinding CreateMinimalClone(ResolvedBinding binding)
        {
            ...
            var properties = requirements.Required.Concat(requirements.Optional)
                    .Concat(new[] { typeof(OriginalStringBindingProperty), typeof(DataContextStack), typeof(LocationInfoBindingProperty), typeof(BindingParserOptions), typeof(BindingCompilationRequirementsAttribute) })
