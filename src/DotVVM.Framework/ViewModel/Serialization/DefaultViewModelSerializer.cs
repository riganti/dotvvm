...
namespace DotVVM.Framework.ViewModel.Serialization
{
    ...
    {
        private const string GeneralViewModelRecomendations = "Check out general viewModel recommendation at http://www.dotvvm.com/docs/tutorials/basics-viewmodels";
