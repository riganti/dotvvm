...
ko.observable = function (initialValue, validator) {
    function observable() {
        if (arguments.length > 0) {
            ...
            if (observable.isDifferent(observable[observableLatestValue], newValue)) {
...
function makeWithIfBinding(bindingKey, isWith, isNot) {
    ko.bindingHandlers[bindingKey] = {
        'init': function(element, valueAccessor, allBindings, viewModel, bindingContext) {
            ...
            ko.computed(function() {
                var value = ko.utils.unwrapObservable(valueAccessor()),
                    shouldDisplay = isWith ? value != null : !isNot !== !value, // equivalent to isNot ? !value : !!value
...
(function () {
    ...
    ko.renderTemplateForEach = function (template, arrayOrObservableArray, options, targetNode, parentBindingContext) {
        ...
        var arrayItemContext, separatorElementsCount, asName = options['as'];
