...
class KnockoutBindingWidget implements virtualDom.Widget {
    ...
    init(): Element {
        ...
        const rootKoContext = KnockoutBindingWidget.createKnockoutContext(this.lastState);
    ...
    public static createKnockoutContext(dataContext: KnockoutObservable<RenderContext<any>>): KnockoutBindingContext {
        const dataComputed = ko.pureComputed(() => KnockoutBindingWidget.wrapInObservables(ko.pureComputed(() => dataContext().dataContext), dataContext().update))
        const result: KnockoutBindingContext =
            dataContext.peek().parentContext ?
                KnockoutBindingWidget.createKnockoutContext(ko.pureComputed(() => dataContext().parentContext || { dataContext: null, update: u => { console.warn("Ou, updating non existent viewModel"); } }))
    ...
    public static wrapInObservables(objOrObservable: any, update: ((updater: StateUpdate<any>) => void) | null = null) {
    ...
    public static createDecorator(element: Element): ((element: RendererInitializer.RenderNodeAst) => RendererInitializer.AssignedPropDescriptor) | undefined {
