...
{
    /// <summary>
    /// Provides functionality of using Microsoft.AspNetCore.Http.Authentication.AuthenticationManager obsoleted in ASP.NET Core 2.0
    /// </summary>
    public class AuthenticationManager
    {
        ...
        public async Task ForbidAsync() => await Context.ForbidAsync();
        ...
        public async Task ForbidAsync(AuthenticationProperties properties) => await Context.ForbidAsync(properties);

        public async Task SignOutAsync(string authenticationScheme) => await Context.SignOutAsync(authenticationScheme);
