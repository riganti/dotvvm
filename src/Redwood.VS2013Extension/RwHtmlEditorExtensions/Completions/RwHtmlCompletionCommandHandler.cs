...
{
    internal class RwHtmlCompletionCommandHandler : IOleCommandTarget
    {
        private IOleCommandTarget m_nextCommandHandler;
        private ITextView m_textView;
        private RwHtmlCompletionHandlerProvider m_provider;
        private ICompletionSession m_session;

        internal RwHtmlCompletionCommandHandler(IVsTextView textViewAdapter, ITextView textView, RwHtmlCompletionHandlerProvider provider)
        {
