...
@"<dot:LinkButton data-manyhandlers />")
        ...
        public void SetBinding_ConcatInHtmlAttributes()
        {
            ...
            Assert.AreEqual("(()=>{let a;return \"a class1-\"+(((a=$data[0])==null?null:a())??\"\")+\" class2-\"+(((a=$data[1])==null?null:a())??\"\");})()", r.Binding.CastTo<IValueBinding>().KnockoutExpression.ToDefaultString());
        }
