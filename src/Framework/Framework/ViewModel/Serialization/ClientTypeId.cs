...
namespace DotVVM.Framework.ViewModel.Serialization
{
    ...
    readonly struct ClientTypeId: IEquatable<ClientTypeId>, IComparable<ClientTypeId>
    {
        ...
        public void WriteJson(System.Text.Json.Utf8JsonWriter writer, ReadOnlySpan<byte> propertyName)
        {
        ...
        public static ClientTypeId ReadJson(ref System.Text.Json.Utf8JsonReader reader)
        {
            if (reader.TokenType == System.Text.Json.JsonTokenType.Null) return default;
            if (reader.TokenType != System.Text.Json.JsonTokenType.String) throw new System.Text.Json.JsonException("Expected string");
