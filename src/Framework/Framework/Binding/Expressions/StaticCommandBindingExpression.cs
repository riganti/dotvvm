...
namespace DotVVM.Framework.Binding.Expressions
{
    ...
    public class StaticCommandBindingExpression : BindingExpression, IStaticCommandBinding
    {
        ...
        public ParametrizedCode CommandJavascript =>
            throw new NotSupportedException("StaticCommandBindingExpression.CommandJavascript is no longer supported. Use KnockoutHelper.GenerateClientPostBackExpression instead.");
