...
namespace DotVVM.Framework.Utils
{
    internal class LimitLengthStream : Stream
    {
        ...
        public sealed class LimitExceededException : InvalidOperationException
        {
            public LimitExceededException(long MaxLength, string Comment): base($"The stream is limited to {MaxLength} bytes: {Comment}")
            {
