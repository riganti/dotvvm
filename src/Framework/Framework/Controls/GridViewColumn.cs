...
namespace DotVVM.Framework.Controls
{
    public abstract class GridViewColumn : DotvvmBindableObject
    {
        ...
        public virtual void CreateFilterControls(IDotvvmRequestContext context, GridView gridView, HtmlGenericControl cell, IGridViewDataSet? sortableGridViewDataSet)
        {
        ...
        private void SetSortedCssClass(HtmlGenericControl cell, IGridViewDataSet? gridViewDataSet, GridViewBindings gridViewCommands)
        {
