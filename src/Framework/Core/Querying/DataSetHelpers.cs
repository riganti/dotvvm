...
namespace DotVVM.Framework.Querying;
...
public class DataSetHelpers
{
    ...
    public static IQueryable<T> ApplySortExpressionToQueryable<T>(IQueryable<T> queryable, string sortExpression, bool sortDescending)
    {
