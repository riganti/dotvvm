...
namespace DotVVM.CommandLine.Commands.Logic
{
    public class DotvvmCSharpParameterModel : CSharpParameterModel
    {
        ...
        public DotvvmCSharpParameterModel(string parameterName, string variableName, string typeName, SwaggerParameter parameter,
            IList<SwaggerParameter> allParameters, CodeGeneratorSettingsBase settings, IClientGenerator generator, DotvvmCSharpOperationModel operation)
