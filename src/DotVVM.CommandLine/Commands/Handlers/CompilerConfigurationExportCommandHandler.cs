            ...
            foreach (var meta in projectsMetadata)
            {
                var opts = new CompilerStartupOptions() {
                    Options = new CompilerOptions {
                        ...
                        CompilationConfiguration = meta.AssemblyName,
                        TargetFramework = meta.TargetFramework,
                    },
                    WaitForDebugger = args.HasOption(CompilerConstants.Arguments.WaitForDebugger),
                    WaitForDebuggerAndBreak = args.HasOption(CompilerConstants.Arguments.WaitForDebuggerAndBreak),
                };
