...
{
    public class EditPageObject : SeleniumHelperBase
    {
        ...
        public ButtonProxy TextsLabel_Save
        {
            get;
        }
        ...
        public EditPageObject(OpenQA.Selenium.IWebDriver webDriver, SeleniumHelperBase parentHelper = null, PathSelector parentSelector = null): base (webDriver, parentHelper, parentSelector)
        {
            ...
            TextsLabel_Save = new ButtonProxy(this, new PathSelector{UiName = "TextsLabel_Save", Parent = parentSelector});
