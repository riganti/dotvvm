...
{
    public class SignInPageObject : SeleniumHelperBase
    {
        ...
        public ButtonProxy TextsLabel_SignIn
        {
            get;
        }

        public RouteLinkProxy TextsLabel_Register
        {
            get;
        }
        ...
        public SignInPageObject(OpenQA.Selenium.IWebDriver webDriver, SeleniumHelperBase parentHelper = null, PathSelector parentSelector = null): base (webDriver, parentHelper, parentSelector)
        {
            ...
            TextsLabel_SignIn = new ButtonProxy(this, new PathSelector{UiName = "TextsLabel_SignIn", Parent = parentSelector});
            TextsLabel_Register = new RouteLinkProxy(this, new PathSelector{UiName = "TextsLabel_Register", Parent = parentSelector});
